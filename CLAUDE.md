...
- **Task tracking lives in `Plans.md`**, not in the numbered docs. `docs/02-BUILD-PLAN.md` is the deployment build plan for the target PC and stays human-authored; `Plans.md` is for in-session task state with `cc:TODO/WIP/DONE` markers.

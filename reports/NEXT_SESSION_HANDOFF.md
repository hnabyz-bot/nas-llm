...
- estimated tokens chars/4: 664,146
- output status: PASS
- extraction run: direct Codex extraction only
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
...
- estimated tokens chars/4: 713,344
- output status: PASS
- extraction run: direct Codex extraction only
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
...
- estimated tokens chars/4: 586,895
- output status: PASS
- extraction run: direct Codex extraction only
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
...
- estimated tokens chars/4: 1,056,545
- output status: PASS
- extraction run: direct Codex extraction plus direct retry for ranks 1202 and
  1235, and chunked fallback for ranks 1245 and 1253
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: ranks 1245 and 1253
...
- estimated tokens chars/4: 636,681
- output status: PASS
- extraction run: direct Codex extraction only
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: none
- ops commit: `ff17a47 feat: complete P1 ranks 1301-1400 extraction outputs`

Latest P1 extraction bundle queued next:

- bundle: `reports/p1-pilot-eval-p1-r1401-r1500-202606270751`
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 1401-1500
- selected representatives: 100
- total available P1 representatives: 2,275
- total normalized chars: 2,326,171
- estimated tokens chars/4: 581,543
- output status: PASS
- extraction run: direct Codex extraction only
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
...
- estimated tokens chars/4: 770,718
- output status: PASS
- extraction run: direct Codex extraction only
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: none
- ops commit: `31881c9 feat: complete P1 ranks 1501-1600 extraction outputs`

Latest P1 extraction bundle queued next:

- bundle: `reports/p1-pilot-eval-p1-r1601-r1700-202606271133`
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 1601-1700
- selected representatives: 100
- total available P1 representatives: 2,275
- total normalized chars: 4,258,084
- estimated tokens chars/4: 1,064,521
- output status: PASS
- extraction run: direct Codex extraction plus chunked fallback for rank 1648
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: rank 1648
- ops commit: `c726a25 feat: complete P1 ranks 1601-1700 extraction outputs`

Latest P1 extraction bundle queued next:

- bundle: `reports/p1-pilot-eval-p1-r1701-r1800-202606271351`
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 1701-1800
- selected representatives: 100
- total available P1 representatives: 2,275
...
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 1801-1900
- selected representatives: 100
- total available P1 representatives: 2,275
- total normalized chars: 3,421,468
- estimated tokens chars/4: 855,367
- output status: PASS
- extraction run: direct Codex extraction plus direct retry for ranks 1829 and
  1898, and chunked fallback for rank 1885
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: rank 1885
...
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 1901-2000
- selected representatives: 100
- total available P1 representatives: 2,275
- total normalized chars: 8,658,134
- estimated tokens chars/4: 2,164,534
- output status: PASS
- extraction run: direct Codex extraction plus direct retry for ranks 1971,
  1985, and 1993, and chunked fallback for ranks 1948, 1949, and 1950
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: ranks 1948, 1949, and 1950
...
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 2001-2100
- selected representatives: 100
- total available P1 representatives: 2,275
- total normalized chars: 5,685,117
- estimated tokens chars/4: 1,421,280
- output status: PASS
- extraction run: direct Codex extraction plus chunked fallback for ranks 2041
  and 2053
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: ranks 2041 and 2053
- ops commit: `8e01b0a feat: complete P1 ranks 2001-2100 extraction outputs`

Latest P1 extraction bundle queued next:

- bundle: `reports/p1-pilot-eval-p1-r2101-r2200-202606280028`
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 2101-2200
- selected representatives: 100
- total available P1 representatives: 2,275
- total normalized chars: 1,007,715
- estimated tokens chars/4: 251,929
- output status: PASS
- extraction run: direct Codex extraction plus direct retry for ranks 2105,
  2124, and 2177, and chunked fallback for rank 2184
- QA summary: 100/100 JSON outputs, 100 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: rank 2184
...
- script: `scripts/prepare-priority-pilot-eval.js`
- representative rank range: 2201-2275
- selected representatives: 75
- total available P1 representatives: 2,275
- total normalized chars: 1,309,376
- estimated tokens chars/4: 327,344
- output status: PASS
- extraction run: direct Codex extraction plus direct retry for ranks 2236,
  2242, 2253, and 2272
- QA summary: 75/75 JSON outputs, 75 pass, 0 fail, validation invalid 0,
  missing evidence 0, page marker leakage 0
- chunked pass rows: none

...
│                                                                 │
│  ┌──────────────┐    ┌──────────────────────────────────────┐   │
│  │  Synology     │    │  D:\vault (HDD 1TB)                  │   │
│  │  Drive Client │───▶│                                      │   │
│  │  (NAS Sync)   │    │  raw/sources/  ← immutable 원본      │   │
│  └──────────────┘    │       │                               │   │
│                       │       │ 인제스트                      │   │
│                       │       ▼                               │   │
│  ┌──────────────┐    │  ┌─────────────────────┐              │   │
...
NAS 원본 자료
    │
    │ ① Synology Drive Client (매일 06:00 자동 동기화)
    ▼
D:\nas-sync\ (스테이징)
    │
    │ ② sync-nas.ps1 (선별 복사, 확장자 필터)
    ▼
D:\vault\raw\sources\ (immutable)
    │
